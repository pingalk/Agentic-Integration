import svgPaths from "./svg-o4u3365dx3";
...
export default function RayInputBox() {
  return (
    <div className="bg-[#f8fafc] border border-[#6db7e8] border-solid overflow-clip relative rounded-[26px] shadow-[0px_6px_32px_4px_rgba(25,40,57,0.09)] size-full" data-name="Ray Input Box">
      ...
      <div className="absolute content-stretch flex gap-[8px] items-center justify-end left-[586px] top-[71px] w-[197px]" data-name="Actions">
