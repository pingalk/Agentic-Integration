import svgPaths from "./svg-543q191ehb";
...
export default function RayInputBox() {
  return (
    <div className="backdrop-blur-[5.5px] backdrop-filter bg-[rgba(255,255,255,0.8)] relative rounded-[100px] size-full" data-name="Ray Input Box">
      <div className="content-stretch flex items-center justify-between overflow-clip px-[12px] py-0 relative rounded-[inherit] size-full">
        <div className="content-stretch flex gap-[8px] items-center px-[4px] py-0 relative shrink-0 w-[305.5px]">
          ...
          <p className="font-['Inter:Regular',sans-serif] leading-[normal] not-italic opacity-0 relative shrink-0 text-[#7d7d7d] text-[14px] text-nowrap tracking-[-0.182px]">Ask anything...</p>
        </div>
        <p className="absolute font-['Inter:Medium',sans-serif] leading-[normal] left-[48px] not-italic text-[#7d7d7d] text-[16px] text-nowrap top-[calc(50%-9px)] tracking-[-0.208px]">Ask anything...</p>
      ...
      <div aria-hidden="true" className="absolute border border-[#d9d9d9] border-solid inset-0 pointer-events-none rounded-[100px] shadow-[0px_6px_32px_4px_rgba(184,196,214,0.06)]" />
    </div>
  );
}