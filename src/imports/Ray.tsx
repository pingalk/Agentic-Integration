...
export default function Ray({ trigger = 0 }: { trigger?: number }) {
  ...
  return (
    <div className="relative size-full overflow-visible" data-name="ray">
      <svg className="block size-full overflow-visible" fill="none" preserveAspectRatio="none" viewBox="0 0 32 32">
        <g id="ray">
          {/* Top Left */}
          <path d="M4 4H13L16 16L4 13V4Z" fill="var(--fill-0, #009E5C)" />
          ...
          >
            <path d="M19 4H28V13L16 16L19 4Z" fill="var(--fill-0, #009E5C)" />
          </g>
          
          {/* Bottom Right */}
          <path d="M28 19V28H19L16 16L28 19Z" fill="var(--fill-0, #009E5C)" />
          
          {/* Bottom Left */}
          <path d="M13 28H4V19L16 16L13 28Z" fill="var(--fill-0, #009E5C)" />
        </g>
      </svg>
    </div>
  );
