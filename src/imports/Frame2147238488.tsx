import svgPaths from "./svg-oln59mq616";
...
function BackgroundImage({ additionalClassNames = "" }: BackgroundImageProps) {
  return (
    <div className={clsx("pointer-events-none relative rounded-[12px] shrink-0 size-[10px]", additionalClassNames)}>
      <div aria-hidden="true" className="absolute border-[0.5px] border-[rgba(0,0,0,0.09)] border-solid inset-0 rounded-[12px]" />
      <div className="absolute inset-0 shadow-[inset_0px_-1px_0px_0px_rgba(0,0,0,0.12)]" />
    </div>
  );
}
...
function Tr() {
  return (
    <div className="content-stretch flex items-start relative shrink-0 w-full" data-name="tr">
      ...
      <BackgroundImageAndText4 text="4567891230" />
      ...
      <BackgroundImage4 text="3 days ago by Dharam Chauhan" />
    ...
    <div className="content-stretch flex flex-col gap-[40px] items-start relative size-full">
      <div className="content-stretch flex flex-col gap-[16px] items-start relative shrink-0 w-[1124px]">
        ...
        <div className="content-stretch flex gap-[12px] items-start relative shrink-0 w-full">
          <div className="h-[254px] relative rounded-[12px] shrink-0 w-[365px]" data-name="39" style={{ backgroundImage: "linear-gradient(90deg, rgb(255, 255, 255) 0%, rgb(255, 255, 255) 100%), linear-gradient(rgb(255, 255, 255) 0%, rgb(255, 255, 255) 27.731%, rgb(255, 255, 255) 71.787%, rgb(247, 247, 248) 100%)" }}>
            <div className="overflow-clip relative rounded-[inherit] size-full">
              ...
              <div className="absolute contents left-[196.34px] top-[115.64px]">
                <div className="absolute flex h-[87.064px] items-center justify-center left-[196.34px] top-[115.64px] w-[95.645px]" style={{ "--transform-inner-width": "0", "--transform-inner-height": "0" } as React.CSSProperties}>
                ...
                <div className="absolute flex h-[124.257px] items-center justify-center left-[242.78px] top-[142.08px] w-[111.544px]" style={{ "--transform-inner-width": "0", "--transform-inner-height": "0" } as React.CSSProperties}>
              ...
              <div className="absolute h-[144.551px] left-[179.14px] top-[177.04px] w-[180.037px]">
                <div className="absolute inset-[-3.3%_-5.17%_-3.81%_-4.77%]">
                  <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 197.938 154.835">
                    <g id="Group 2147234127">
                      <path d={svgPaths.p25c23500} fill="var(--fill-0, #75A3FF)" id="Rectangle 1891601673" stroke="url(#paint0_linear_50_9289)" strokeWidth="1.19408" />
                      <path d={svgPaths.p34cfa450} fill="var(--fill-0, #75A3FF)" id="Rectangle 1891601675" />
                      <g filter="url(#filter0_f_50_9289)" id="Rectangle 1891601674">
                        <path d={svgPaths.p34deac00} fill="var(--fill-0, #A7E6F9)" />
                      </g>
                    </g>
                    <defs>
                      <filter colorInterpolationFilters="sRGB" filterUnits="userSpaceOnUse" height="154.835" id="filter0_f_50_9289" width="197.938" x="0" y="4.76837e-07">
                        <feFlood floodOpacity="0" result="BackgroundImageFix" />
                        <feBlend in="SourceGraphic" in2="BackgroundImageFix" mode="normal" result="shape" />
                        <feGaussianBlur result="effect1_foregroundBlur_50_9289" stdDeviation="11.4767" />
                      </filter>
                      <linearGradient gradientUnits="userSpaceOnUse" id="paint0_linear_50_9289" x1="193.781" x2="101.69" y1="16.9701" y2="198.226">
              ...
              <div className="absolute flex h-[73.762px] items-center justify-center left-[116.06px] mix-blend-overlay top-[173.62px] w-[67.224px]" style={{ "--transform-inner-width": "300", "--transform-inner-height": "150" } as React.CSSProperties}>
                <div className="flex-none rotate-[30.917deg]">
                  <BackgroundImage10 additionalClassNames="h-[60.89px] w-[41.891px]">
          ...
          <div className="basis-0 content-stretch flex flex-col gap-[12px] grow h-[254px] items-start min-h-px min-w-px relative shrink-0">
            ...
            <BackgroundImage11 additionalClassNames="w-full">
              <div className="overflow-clip rounded-[inherit] size-full">
                <div className="content-stretch flex flex-col gap-[10px] items-start px-[20px] py-[16px] relative size-full">
                  <div className="content-stretch flex flex-col gap-[24px] items-start relative shrink-0 w-full">
                    <div className="content-stretch flex items-center justify-between relative shrink-0 w-full">
                      <div className="content-stretch flex items-center relative shrink-0 w-[133.167px]">
                        <BackgroundImageAndText5 text="Method Split">
                          <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 97 1">
                            <line id="Line 1465" opacity="0.4" stroke="var(--stroke-0, #606C75)" strokeDasharray="3 3" x2="97" y1="0.5" y2="0.5" />
                          </svg>
                        </BackgroundImageAndText5>
                      </div>
                      <div className="flex flex-row items-center self-stretch">
                    ...
                    <div className="content-stretch flex flex-col gap-[24px] items-start relative shrink-0 w-full">
                      <div className="content-stretch flex flex-col items-start relative shrink-0 w-full">
                        <div className="content-stretch flex gap-[4px] h-[12px] items-center relative rounded-[2px] shrink-0 w-full">
                          <div className="bg-[#4d7fff] h-full relative rounded-bl-[4px] rounded-tl-[4px] shrink-0 w-[313px]" data-name="Juicy ones 9">
                            <div className="overflow-clip rounded-[inherit] size-full">
                              <div className="content-stretch flex flex-col items-start px-[20px] py-[16px] relative size-full">
                                <div className="h-[24px] shrink-0 w-[64px]" />
                              </div>
                            </div>
                            <div className="absolute inset-0 pointer-events-none shadow-[inset_0px_-1px_0px_0px_rgba(0,0,0,0.12)]" />
                            <div aria-hidden="true" className="absolute border-[0.5px] border-[rgba(0,0,0,0.09)] border-solid inset-0 pointer-events-none rounded-bl-[4px] rounded-tl-[4px]" />
                          </div>
                          <div className="basis-0 bg-[#6ed00b] grow h-full min-h-px min-w-px relative shrink-0" data-name="Juicy ones 5">
                            <div className="overflow-clip rounded-[inherit] size-full">
                              <div className="content-stretch flex flex-col items-start px-[20px] py-[4px] relative size-full">
                                <div className="h-[24px] shrink-0 w-[64px]" />
                              </div>
                            </div>
                            <div className="absolute inset-0 pointer-events-none shadow-[inset_0px_-1px_0px_0px_rgba(0,0,0,0.12)]" />
                            <div aria-hidden="true" className="absolute border-[0.5px] border-[rgba(0,0,0,0.09)] border-solid inset-0 pointer-events-none" />
                          </div>
                          <div className="bg-[#9e8ff8] h-full relative shrink-0 w-[125px]" data-name="Juicy ones 6">
                            <div className="content-stretch flex flex-col items-start overflow-clip px-[20px] py-[4px] relative rounded-[inherit] size-full">
                              <div className="h-[24px] shrink-0 w-[64px]" />
                            </div>
                            <div className="absolute inset-0 pointer-events-none shadow-[inset_0px_-1px_0px_0px_rgba(0,0,0,0.12)]" />
                            <div aria-hidden="true" className="absolute border-[0.5px] border-[rgba(0,0,0,0.09)] border-solid inset-0 pointer-events-none" />
                          </div>
                          <div className="bg-[#52b4d0] h-full relative rounded-br-[4px] rounded-tr-[4px] shrink-0 w-[55px]" data-name="Juicy ones 8">
                            <div className="content-stretch flex flex-col items-start overflow-clip px-[20px] py-[4px] relative rounded-[inherit] size-full">
                              <div className="h-[24px] shrink-0 w-[64px]" />
                            </div>
                            <div className="absolute inset-0 pointer-events-none shadow-[inset_0px_-1px_0px_0px_rgba(0,0,0,0.12)]" />
                            <div aria-hidden="true" className="absolute border-[0.5px] border-[rgba(0,0,0,0.09)] border-solid inset-0 pointer-events-none rounded-br-[4px] rounded-tr-[4px]" />
                          </div>
                        </div>
                      </div>
                      <div className="content-stretch flex gap-[16px] items-start relative shrink-0 w-full">
                        <div className="basis-0 content-stretch flex gap-[6px] grow items-start min-h-px min-w-px relative shrink-0">
                          <div className="content-stretch flex gap-[8px] items-center relative shrink-0">
                            <div className="bg-[#4d7fff] pointer-events-none relative rounded-[6px] shrink-0 size-[10px]">
                              <div aria-hidden="true" className="absolute border-[0.5px] border-[rgba(0,0,0,0.09)] border-solid inset-0 rounded-[6px] shadow-[0px_6px_32px_4px_rgba(184,196,214,0.06)]" />
                              <div className="absolute inset-0 shadow-[inset_0px_-1px_0px_0px_rgba(0,0,0,0.12)]" />
                            </div>
                            <p className="font-['Inter:SemiBold',sans-serif] leading-[normal] not-italic relative shrink-0 text-[#050505] text-[14px] text-nowrap text-right tracking-[-0.182px]">52%</p>
                          </div>
                          <p className="font-['Inter:Medium',sans-serif] leading-[normal] not-italic relative shrink-0 text-[#606c75] text-[14px] text-nowrap tracking-[-0.182px]">Domestic Online</p>
                        </div>
                        <div className="basis-0 content-stretch flex gap-[6px] grow items-start min-h-px min-w-px relative shrink-0">
                          <div className="content-stretch flex gap-[8px] items-center relative shrink-0">
                            <BackgroundImage additionalClassNames="bg-[#6ed00b]" />
                            <p className="font-['Inter:SemiBold',sans-serif] leading-[normal] not-italic relative shrink-0 text-[#050505] text-[14px] text-nowrap text-right tracking-[-0.182px]">24%</p>
                          </div>
                          <p className="font-['Inter:Medium',sans-serif] leading-[normal] not-italic relative shrink-0 text-[#606c75] text-[14px] text-nowrap tracking-[-0.182px]">International</p>
                        </div>
                        <div className="basis-0 content-stretch flex gap-[6px] grow items-start min-h-px min-w-px relative shrink-0">
                          <div className="content-stretch flex gap-[8px] items-center relative shrink-0">
                            <BackgroundImage additionalClassNames="bg-[#9e8ff8]" />
                            <p className="font-['Inter:SemiBold',sans-serif] leading-[normal] not-italic relative shrink-0 text-[#050505] text-[14px] text-nowrap text-right tracking-[-0.182px]">12%</p>
                          </div>
                          <p className="font-['Inter:Medium',sans-serif] leading-[normal] not-italic relative shrink-0 text-[#606c75] text-[14px] text-nowrap tracking-[-0.182px]">Offline</p>
                        </div>
                        <div className="basis-0 content-stretch flex gap-[6px] grow items-start min-h-px min-w-px relative shrink-0">
                          <div className="content-stretch flex gap-[8px] items-center relative shrink-0">
                            <BackgroundImage additionalClassNames="bg-[#52b4d0]" />
                            <p className="font-['Inter:SemiBold',sans-serif] leading-[normal] not-italic relative shrink-0 text-[#050505] text-[14px] text-nowrap text-right tracking-[-0.182px]">8%</p>
                          </div>
                          <p className="font-['Inter:Medium',sans-serif] leading-[normal] not-italic relative shrink-0 text-[#606c75] text-[14px] text-nowrap tracking-[-0.182px]">Others</p>
                        </div>
                      </div>
                    </div>
                  </div>
                ...
                <div className="content-stretch flex items-center justify-between p-[12px] relative size-full">
                  <div className="content-stretch flex gap-[8px] items-start relative shrink-0">
                    <div className="content-stretch flex gap-[4px] h-[32px] items-center overflow-clip px-[8px] py-[6px] relative rounded-[8px] shrink-0">
                      ...
                      <BackgroundImage2 text="All GRNs" text1="320" />
                    </div>
                    ...
                    <div className="content-stretch flex gap-[4px] h-[32px] items-center overflow-clip px-[8px] py-[6px] relative rounded-[8px] shrink-0">
                      ...
                      <BackgroundImage2 text="Created" text1="125" />
                    </div>
                    <div className="content-stretch flex gap-[4px] h-[32px] items-center overflow-clip px-[8px] py-[6px] relative rounded-[8px] shrink-0">
                      <div className="content-stretch flex gap-[6px] items-center relative shrink-0">
                        <BackgroundImage1 />
                      </div>
                      <BackgroundImage2 text="Invoiced" text1="64" />
                    </div>
                    <div className="content-stretch flex gap-[4px] h-[32px] items-center overflow-clip px-[8px] py-[6px] relative rounded-[8px] shrink-0">
                      <div className="content-stretch flex gap-[6px] items-center relative shrink-0">
                        <BackgroundImage1 />
                      </div>
                      <BackgroundImage2 text="Closed" text1="127" />
                    </div>
                  </div>
                      ...
                      <div className="bg-white content-stretch flex flex-col items-start overflow-clip relative rounded-[8px] shrink-0 w-full">
                        <div className="content-stretch flex h-[36px] items-start relative shrink-0 w-full" data-name="tr">
                          ...
                          <div className="content-stretch flex flex-col h-full items-start justify-center px-[24px] py-[16px] relative shrink-0 w-[72px]" data-name="td">
                            <BackgroundImage10 additionalClassNames="shrink-0 size-[12px]">
                        ...
                        <div className="content-stretch flex flex-col items-start overflow-clip relative shrink-0 w-full">
                          <div className="content-stretch flex items-start relative shrink-0 w-full" data-name="tr">
                            ...
                            <BackgroundImageAndText4 text="6482937429" />
                            <div className="content-stretch flex flex-col h-[48px] items-start justify-center px-[24px] py-[16px] relative shrink-0 w-[128px]" data-name="td">
                              <div className="bg-[#e1f0e9] content-stretch flex items-center px-[8px] py-[3px] relative rounded-[23px] shrink-0" data-name="content">
                                <DetailsBackgroundImageAndText text="Captured" />
                              </div>
                            ...
                            <BackgroundImage4 text="a day ago by Saurav Rastogi" />
                            <div className="content-stretch flex flex-col h-[48px] items-end justify-center pl-[24px] pr-[26px] py-[16px] relative shrink-0 w-[72px]" data-name="td">
                              <MoreHorizontalBackgroundImage />
                            </div>
                          </div>
                          <div className="bg-[rgba(23,42,76,0)] content-stretch flex items-start relative shrink-0 w-full" data-name="tr">
                            ...
                            <BackgroundImageAndText4 text="1242940202" />
                            <div className="content-stretch flex flex-col h-[48px] items-start justify-center px-[24px] py-[16px] relative shrink-0 w-[128px]" data-name="td">
                            ...
                            <BackgroundImage4 text="2 weeks ago by Rama Krushna" />
                            <div className="content-stretch flex flex-col h-[48px] items-end justify-center pl-[24px] pr-[26px] py-[16px] relative shrink-0 w-[72px]" data-name="td">
                              <MoreHorizontalBackgroundImage />
                            </div>
                          </div>
                          <div className="content-stretch flex items-start relative shrink-0 w-full" data-name="tr">
                            ...
                            <BackgroundImage4 text="3 days ago by Ashutosh Gupta" />
                            <div className="content-stretch flex flex-col h-[48px] items-end justify-center pl-[24px] pr-[26px] py-[16px] relative shrink-0 w-[72px]" data-name="td">
                              <MoreHorizontalBackgroundImage />
                            </div>
                          </div>
                          <div className="bg-[rgba(23,42,76,0)] content-stretch flex items-start relative shrink-0 w-full" data-name="tr">
                            ...
                            <BackgroundImageAndText4 text="9876543210" />
                            <div className="content-stretch flex flex-col h-[48px] items-start justify-center px-[24px] py-[16px] relative shrink-0 w-[128px]" data-name="td">
                            ...
                            <BackgroundImage4 text="1 week ago by Pingal Kakti" />
                            <div className="content-stretch flex flex-col h-[48px] items-end justify-center pl-[24px] pr-[26px] py-[16px] relative shrink-0 w-[72px]" data-name="td">
                              <MoreHorizontalBackgroundImage />
                            </div>
                          </div>
                          ...
                          <div className="content-stretch flex items-start relative shrink-0 w-full" data-name="tr">
                            ...
                            <BackgroundImageAndText4 text="3216549870" />
                            <div className="content-stretch flex flex-col h-[48px] items-start justify-center px-[24px] py-[16px] relative shrink-0 w-[128px]" data-name="td">
                              <div className="bg-[#e1f0e9] content-stretch flex items-center px-[8px] py-[3px] relative rounded-[23px] shrink-0" data-name="content">
                                <DetailsBackgroundImageAndText text="Captured" />
                              </div>
                            ...
                            <BackgroundImage4 text="5 days ago by Anita Singh" />
                            <div className="content-stretch flex flex-col h-[48px] items-end justify-center pl-[24px] pr-[26px] py-[16px] relative shrink-0 w-[72px]" data-name="td">
                              <MoreHorizontalBackgroundImage />
                            </div>
                          </div>
                          ...
                          <div className="content-stretch flex items-start relative shrink-0 w-full" data-name="tr">
                            ...
                            <BackgroundImageAndText4 text="7894561230" />
                            <div className="content-stretch flex flex-col h-[48px] items-start justify-center px-[24px] py-[16px] relative shrink-0 w-[128px]" data-name="td">
                              <div className="bg-[#e1f0e9] content-stretch flex items-center px-[8px] py-[3px] relative rounded-[23px] shrink-0" data-name="content">
                                <DetailsBackgroundImageAndText text="Captured" />
                              </div>
                            ...
                            <BackgroundImage4 text="2 days ago by Priya Mehta" />
                            <div className="content-stretch flex flex-col h-[48px] items-end justify-center pl-[24px] pr-[26px] py-[16px] relative shrink-0 w-[72px]" data-name="td">
                              <MoreHorizontalBackgroundImage />
                            </div>
                          </div>
                          ...
                          <div className="content-stretch flex items-start relative shrink-0 w-full" data-name="tr">
                            ...
                            <BackgroundImageAndText4 text="1122334455" />
                            <div className="content-stretch flex flex-col h-[48px] items-start justify-center px-[24px] py-[16px] relative shrink-0 w-[128px]" data-name="td">
                              <div className="bg-[#e1f0e9] content-stretch flex items-center px-[8px] py-[3px] relative rounded-[23px] shrink-0" data-name="content">
                                <DetailsBackgroundImageAndText text="Captured" />
                              </div>
                            ...
                            <BackgroundImage4 text="1 week ago by Sameer Verma" />
                            <div className="content-stretch flex flex-col h-[48px] items-end justify-center pl-[24px] pr-[26px] py-[16px] relative shrink-0 w-[72px]" data-name="td">
                              <MoreHorizontalBackgroundImage />
                            </div>
                          </div>
