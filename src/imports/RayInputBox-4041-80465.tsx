import svgPaths from "./svg-2oiw0m6xxf";
...
function CursorText() {
  return (
    <div className="content-stretch flex gap-[2px] items-center relative shrink-0 w-[358px]" data-name="Cursor + Text">
      ...
      <p className="css-ew64yg font-['Inter:Medium',sans-serif] leading-[24px] not-italic relative shrink-0 text-[#7d7d7d] text-[16px] tracking-[-0.208px]">Ask anything...</p>
    </div>
  );
}
...
export default function RayInputBox() {
  return (
    <div className="backdrop-blur-[5.5px] bg-[rgba(255,255,255,0.9)] relative rounded-[24px] size-full" data-name="Ray Input Box">
