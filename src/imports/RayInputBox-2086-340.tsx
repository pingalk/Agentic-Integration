import svgPaths from "./svg-sqoo3rwgtq";
...
type CursorTextBackgroundImageAndTextProps = {
  text: string;
};

function CursorTextBackgroundImageAndText({ text }: CursorTextBackgroundImageAndTextProps) {
  return (
    <div className="content-stretch flex gap-[2px] items-center relative shrink-0 w-[358px]">
      <p className="font-['Inter:Medium',sans-serif] leading-[24px] not-italic relative shrink-0 text-[#40566d] text-[16px] text-nowrap tracking-[-0.208px]">{text}</p>
    </div>
  );
}

export default function RayInputBox() {
  return (
    <div className="backdrop-blur-[5.5px] backdrop-filter bg-[rgba(255,255,255,0.9)] relative rounded-[24px] size-full" data-name="Ray Input Box">
      <div className="content-stretch flex items-start justify-between overflow-clip p-[12px] relative rounded-[inherit] size-full">
        <div className="basis-0 grow min-h-px min-w-[260px] relative shrink-0" data-name="Ray Logo + Text">
          <div className="content-stretch flex gap-[8px] items-start min-w-[inherit] p-[4px] relative w-full">
            ...
            <div className="content-stretch flex flex-col gap-[8px] items-start relative shrink-0">
              <CursorTextBackgroundImageAndText text="I have a few doubts regarding my settlements. Can you" />
              <CursorTextBackgroundImageAndText text="help me with this?" />
            </div>
          </div>
        </div>
        <div className="absolute bottom-[12px] content-stretch flex gap-[8px] items-end justify-end right-[12px] w-[197px]" data-name="Actions">
