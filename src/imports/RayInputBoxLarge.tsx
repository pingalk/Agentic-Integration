import svgPaths from "./svg-tx7wrw30mz";
...
export default function RayInputBoxLarge() {
  return (
    <div className="backdrop-blur-[5.5px] backdrop-filter bg-[rgba(255,255,255,0.9)] relative rounded-[24px] size-full" data-name="Ray Input Box / Large">
      <div className="content-stretch flex items-start justify-between overflow-clip p-[12px] relative rounded-[inherit] size-full">
        <div className="content-stretch flex gap-[8px] items-center p-[4px] relative shrink-0" data-name="Ray Logo + Text">
          ...
          <div className="content-stretch flex gap-[2px] items-center relative shrink-0 w-[358px]" data-name="Cursor + Text">
            ...
            <p className="font-['Inter:Medium',sans-serif] leading-[24px] not-italic relative shrink-0 text-[#7d7d7d] text-[16px] text-nowrap tracking-[-0.208px]">Ask anything...</p>
          </div>
        </div>
