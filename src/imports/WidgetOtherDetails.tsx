import svgPaths from "./svg-v80cotvtkk";
...
function Radio1() {
  return (
    <Wrapper>
      <circle cx="6" cy="6" id="radio-background" r="5.25" stroke="var(--stroke-0, #CBD5E2)" strokeWidth="1.5" />
    </Wrapper>
  );
}
type LabelTextProps = {
...
function LabelText({ text }: LabelTextProps) {
  return (
    <div className="content-stretch flex items-start relative shrink-0 w-full">
      <p className="basis-0 font-['Inter:Regular',sans-serif] grow leading-[18px] min-h-px min-w-px not-italic relative shrink-0 text-[#40566d] text-[12px]">{text}</p>
    </div>
  );
}
...
function Radio() {
  return (
    <Wrapper>
      <circle cx="6" cy="6" fill="var(--fill-0, #305EFF)" id="radio-background" r="6" />
      <circle cx="6" cy="6" fill="var(--fill-0, white)" id="radio-center" r="2" />
    </Wrapper>
  );
}
              ...
              <div className="content-stretch flex gap-[15px] items-start relative shrink-0">
                <div className="content-stretch flex flex-col items-start relative shrink-0 w-[120px]" data-name="Radio">
                  <div className="content-stretch flex gap-[4px] items-start px-0 py-[2px] relative shrink-0 w-full" data-name="root">
                    <div className="content-stretch flex flex-col items-start justify-center overflow-clip p-[2px] relative rounded-[2px] shrink-0 size-[16px]" data-name="_Radio Base">
                      <div className="basis-0 content-stretch flex grow items-center justify-center min-h-px min-w-px relative shrink-0 w-full" data-name="root">
                        <Radio />
                      </div>
                    </div>
                ...
                <div className="content-stretch flex flex-col items-start relative shrink-0 w-[120px]" data-name="Radio">
                  <div className="content-stretch flex gap-[4px] items-start px-0 py-[2px] relative shrink-0 w-full" data-name="root">
                    <div className="content-stretch flex flex-col items-start justify-center overflow-clip p-[2px] relative rounded-[2px] shrink-0 size-[16px]" data-name="_Radio Base">
                      <div className="basis-0 content-stretch flex grow items-start justify-center min-h-px min-w-px relative shrink-0 w-full" data-name="root">
                        <Radio1 />
                      </div>
                    </div>
                    <div className="basis-0 content-stretch flex flex-col grow items-start min-h-px min-w-px relative shrink-0" data-name="label-group">
