import svgPaths from "./svg-r8pjqrwzle";
...
export default function WidgetCustomerDetails() {
  return (
    <div className="bg-[#edece8] content-stretch flex flex-col items-start p-[4px] relative rounded-[8px] size-full" data-name="Widget - Customer details">
              ...
              <div className="flex flex-row items-center overflow-clip rounded-[inherit] size-full">
                <div className="content-stretch flex items-center justify-between px-[4px] py-0 relative w-full">
                  <div className="content-stretch flex flex-col gap-[4px] items-start relative shrink-0">
                    <p className="font-['Inter:SemiBold',sans-serif] leading-[24px] not-italic relative shrink-0 text-[#222] text-[16px] text-nowrap">Customer Details</p>
                  </div>
                              ...
                              <div className="bg-white h-[48px] relative rounded-tl-[4px] rounded-tr-[4px] shrink-0 w-full" data-name="field">
                                ...
                                <Wrapper>
                                  <div className="basis-0 content-center flex flex-wrap gap-0 grow items-center min-h-px min-w-px relative shrink-0" data-name="leading">
                                    <Value>
                                      <p className="font-['Inter:Regular',sans-serif] leading-[24px] not-italic relative shrink-0 text-[#40566d] text-[16px] text-nowrap">arvind@gmail.com</p>
                                    </Value>
                                  </div>
                                </Wrapper>
                              </div>
                            ...
                            <div className="content-stretch flex flex-col items-start justify-center relative shrink-0 w-full" data-name="FormGroup-Body">
                              <div className="bg-white h-[48px] relative rounded-bl-[4px] rounded-br-[4px] shrink-0 w-full" data-name="field">
                                ...
                                <Wrapper>
                                  <div className="basis-0 content-center flex flex-wrap gap-0 grow items-center min-h-px min-w-px relative shrink-0" data-name="leading">
                                    <Value>
                                      <p className="font-['Inter:Regular',sans-serif] leading-[24px] not-italic opacity-40 relative shrink-0 text-[#40566d] text-[16px] text-nowrap">Phone number (optional)</p>
                                    </Value>
                                  </div>
                                </Wrapper>
                              </div>
