import svgPaths from "./svg-oyzbjsmmh7";
...
export default function MainContent() {
  return (
    <div className="content-stretch flex flex-col gap-[84px] items-start relative size-full" data-name="Main Content">
      ...
      <div className="content-stretch flex flex-col gap-[16px] h-[664px] items-start relative shrink-0 w-full" data-name="Table Content">
