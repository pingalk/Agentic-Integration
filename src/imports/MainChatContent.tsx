import svgPaths from "./svg-abyx0p8cx2";
...
function Response() {
  return (
    <div className="content-stretch flex flex-col gap-[28px] items-start relative shrink-0 w-full" data-name="Response 1">
      <PrimaryContentBlock />
      <RayInsight />
      <Footer2 />
    </div>
...
function SuggestionsBlock() {
  return (
    <div className="content-stretch flex flex-col gap-[12px] items-start relative shrink-0 w-full" data-name="Suggestions Block">
...
export default function MainChatContent() {
  return (
    <div className="content-stretch flex flex-col gap-[48px] items-start relative size-full" data-name="Main Chat Content">
      <Response />
      <SuggestionsBlock />
    </div>
  );
