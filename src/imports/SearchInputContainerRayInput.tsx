import svgPaths from "./svg-h0tl9nb0vi";

function Text() {
  return (
    <div className="absolute content-stretch flex gap-[8px] items-center left-[18px] top-[17px] w-[305.5px]" data-name="Text">
...
function Buttons() {
  return (
    <div className="absolute content-stretch flex gap-[8px] items-center justify-end left-[586px] top-[71px] w-[197px]" data-name="Buttons">
      <Frame2 />
      <Frame1 />
    </div>
  );
...
export default function SearchInputContainerRayInput() {
  return (
    <div className="bg-[#f8fafc] border border-[#6db7e8] border-solid overflow-clip relative rounded-[26px] shadow-[0px_6px_32px_4px_rgba(25,40,57,0.09)] size-full" data-name="Search Input Container (Ray Input)">
      <Text />
      <Buttons />
    </div>
  );
