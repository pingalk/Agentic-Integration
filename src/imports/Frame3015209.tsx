import svgPaths from "./svg-mr37vl21kr";
...
function Helper({ text, text1 }: HelperProps) {
  return (
    <div className="content-stretch flex gap-[6px] items-start relative shrink-0 text-[14px] text-nowrap w-[262px]">
...
function Text5({ text }: Text5Props) {
  return (
    <div className="content-stretch flex gap-[6px] items-start relative shrink-0 w-full">
      <div className="flex flex-col font-['Inter:Semi_Bold',sans-serif] font-semibold justify-center leading-[0] not-italic relative shrink-0 text-[#192839] text-[14px] text-nowrap">
...
function TitleText1({ text }: TitleText1Props) {
  return (
    <div className="content-stretch flex gap-[6px] items-center relative shrink-0 w-[200px]">
...
function Divider() {
  return (
    <Wrapper>
      <line id="Divider Line" stroke="var(--stroke-0, #6C849D)" strokeOpacity="0.18" x2="618" y1="0.5" y2="0.5" />
    </Wrapper>
  );
}
type Text2Props = {
      ...
      <div className="content-stretch flex gap-[16px] items-start relative shrink-0">
        <div className="content-stretch flex flex-col gap-[16px] items-start relative shrink-0">
          <div className="content-stretch flex flex-col gap-[4px] items-start relative shrink-0">
            <div className="bg-white content-stretch flex flex-col items-start p-[24px] relative rounded-[4px] shrink-0 w-[650px]" data-name="Card">
                    ...
                    <div className="content-stretch flex flex-col gap-[8px] items-start relative shrink-0">
                      <div className="content-stretch flex gap-[16px] items-center relative shrink-0">
                        <div className="relative shrink-0 size-[60px]" data-name="State">
                          <div className="absolute bg-[rgba(0,162,81,0.09)] content-stretch flex inset-0 items-start overflow-clip p-[14px] rounded-[4px]">
                            <div className="relative shrink-0 size-[32px]" data-name="check">
                              <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 32 32">
                                <g id="check">
                                  <path clipRule="evenodd" d={svgPaths.p91a7880} fill="var(--fill-0, #008743)" fillRule="evenodd" id="path" />
                                </g>
                              </svg>
                            </div>
                          </div>
                          ...
                          <div className="content-stretch flex gap-[8px] items-center relative shrink-0">
                            ...
                            <div className="content-stretch flex items-start overflow-clip relative shrink-0" data-name="Badge/captured">
                              <div className="content-stretch flex flex-col items-start justify-center relative rounded-[4px] shrink-0" data-name="root">
                                <div className="bg-[rgba(0,162,81,0.09)] content-stretch flex gap-[4px] h-[24px] items-center px-[12px] py-0 relative rounded-[1000px] shrink-0" data-name="wrapper">
                                  <p className="font-['Inter:Medium',sans-serif] leading-[18px] not-italic relative shrink-0 text-[#008743] text-[12px] text-nowrap">Label</p>
                                </div>
                              </div>
                            </div>
                          </div>
                      ...
                      <div className="content-stretch flex gap-[4px] items-start relative shrink-0 w-full">
                        <p className="font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[18px] not-italic relative shrink-0 text-[#192839] text-[12px] text-nowrap">Refund of ₹5,000 issued to the customer on Feb 9, 2023</p>
            ...
            <div className="bg-white content-stretch flex flex-col items-start relative rounded-[4px] shrink-0 w-[650px]" data-name="Card">
              <div aria-hidden="true" className="absolute border border-[rgba(108,132,157,0.18)] border-solid inset-0 pointer-events-none rounded-[4px]" />
              <div className="content-stretch flex flex-col gap-[12px] items-start relative shrink-0 w-full" data-name="card-content-holder">
                <div className="content-stretch flex items-start relative shrink-0 w-full" data-name="card-body">
                  <div className="basis-0 content-stretch flex flex-col grow items-center justify-center min-h-px min-w-px relative rounded-[4px] shrink-0" data-name="Slot">
                    <div className="content-stretch flex flex-col items-start relative shrink-0" data-name="Amount breakup content">
                      <div className="bg-white relative rounded-tl-[4px] rounded-tr-[4px] shrink-0 w-[650px]" data-name="Breakup">
                        <div className="content-stretch flex flex-col items-start overflow-clip pb-[12px] pt-[16px] px-[16px] relative rounded-[inherit] w-full">
                          <div className="content-stretch flex flex-col gap-[8px] items-end relative shrink-0 w-full">
                            ...
                            <Wrapper>
                              <line id="Divider Line" stroke="var(--stroke-0, #6C849D)" strokeDasharray="5 5" strokeOpacity="0.18" x2="618" y1="0.5" y2="0.5" />
                            </Wrapper>
                      ...
                      <div className="bg-[#f1f5fa] content-stretch flex flex-col items-start px-[16px] py-[12px] relative rounded-bl-[4px] rounded-br-[4px] shrink-0 w-[650px]" data-name="Footer">
                        ...
                        <div className="content-stretch flex gap-[4px] items-center relative shrink-0 w-full">
                          <p className="font-['Inter:Regular',sans-serif] leading-[18px] not-italic relative shrink-0 text-[#40566d] text-[12px] text-nowrap">Net amount to be deposited in your bank account by Feb 14, 2023</p>
                          <div className="content-stretch flex flex-col items-start relative shrink-0" data-name="Link">
                            <div className="content-stretch flex items-center justify-center relative shrink-0" data-name="root">
                              <div className="content-stretch flex gap-[4px] items-center justify-center relative shrink-0" data-name="wrapper">
          ...
          <div className="bg-white content-stretch flex flex-col items-start relative rounded-[4px] shrink-0 w-[650px]" data-name="Card">
            ...
            <div className="content-stretch flex flex-col gap-[12px] items-start relative shrink-0 w-full" data-name="card-content-holder">
              <div className="content-stretch flex items-start relative shrink-0 w-full" data-name="card-body">
                <div className="basis-0 content-stretch flex flex-col grow items-center justify-center min-h-px min-w-px relative rounded-[4px] shrink-0" data-name="Slot">
                  <div className="content-stretch flex flex-col items-start relative shrink-0" data-name="Payment Card/Desktop">
                    <div className="bg-[rgba(108,132,157,0.09)] content-stretch flex gap-[8px] h-[56px] items-center pl-[20px] pr-[16px] py-[16px] relative rounded-tl-[4px] rounded-tr-[4px] shrink-0 w-[650px]" data-name="Header">
                      <HeadingText text="Details" />
                    </div>
                    <div className="bg-white content-stretch flex flex-col gap-[16px] items-start px-[20px] py-[16px] relative rounded-bl-[4px] rounded-br-[4px] shrink-0 w-[650px]" data-name="Body">
                      <div aria-hidden="true" className="absolute border-[0px_1px_1px] border-[rgba(108,132,157,0.18)] border-solid inset-0 pointer-events-none rounded-bl-[4px] rounded-br-[4px]" />
                      <div className="content-stretch flex flex-col gap-[12px] items-start relative shrink-0" data-name="Default State">
                        <div className="content-stretch flex gap-[12px] items-start relative shrink-0" data-name="List Item">
                          <TitleText text="Payment ID" />
                          <div className="content-stretch flex flex-col gap-[4px] items-start relative shrink-0" data-name="Value list">
                            <div className="h-[20px] relative shrink-0 w-[398px]" data-name="Value">
                              <div className="absolute content-stretch flex gap-[4px] items-center left-0 top-0" data-name="value">
                                <p className="font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[20px] not-italic relative shrink-0 text-[#192839] text-[14px] text-nowrap">pay_LM93MI0K4sEmbQ</p>
                        ...
                        <div className="content-stretch flex gap-[12px] items-start relative shrink-0" data-name="List Item">
                          ...
                          <div className="content-stretch flex flex-col gap-[4px] items-start relative shrink-0" data-name="Value list">
                            <div className="h-[20px] relative shrink-0 w-[398px]" data-name="Value">
                              <div className="absolute content-stretch flex gap-[4px] items-center left-0 top-0" data-name="value">
                                <p className="font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[20px] not-italic relative shrink-0 text-[#192839] text-[14px] text-nowrap">order_usfeiufgey3247</p>
                                <div className="content-stretch flex items-center justify-center relative shrink-0" data-name="copy">
                                  <div className="content-stretch flex items-center justify-center relative shrink-0" data-name="root">
                                    <div className="content-stretch flex items-center justify-center relative shrink-0" data-name="wrapper">
                                      <IconWrapper />
            ...
            <div className="content-stretch flex flex-col gap-[12px] items-start relative shrink-0 w-full" data-name="card-content-holder">
              <div className="content-stretch flex items-start relative shrink-0 w-full" data-name="card-body">
                <div className="basis-0 content-stretch flex flex-col grow items-start min-h-px min-w-px relative shrink-0" data-name="Refund Card">
                  ...
                  <div className="bg-white content-stretch flex flex-col gap-[16px] items-start px-[20px] py-[16px] relative rounded-[2px] shrink-0 w-[650px]" data-name="Body">
                    ...
                    <div className="content-stretch flex flex-col gap-[12px] items-start relative shrink-0" data-name="Default State">
                      <div className="content-stretch flex gap-[12px] items-start relative shrink-0" data-name="List Item">
                        <TitleText text="Refund ID" />
                        <div className="content-stretch flex flex-col gap-[4px] items-start relative shrink-0" data-name="Value list">
                          <div className="h-[20px] relative shrink-0 w-[398px]" data-name="Value">
                            <div className="absolute content-stretch flex gap-[4px] items-center left-0 top-0" data-name="value">
                              <p className="font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[20px] not-italic relative shrink-0 text-[#192839] text-[14px] text-nowrap">rfnd_LM93MI0K4sEmbQ</p>
                              <div className="content-stretch flex items-center justify-center relative shrink-0" data-name="copy">
                                <div className="content-stretch flex items-center justify-center relative shrink-0" data-name="root">
                                  <div className="content-stretch flex items-center justify-center relative shrink-0" data-name="wrapper">
                                    <IconWrapper />
                      ...
                      <Divider />
                      <div className="content-stretch flex gap-[12px] items-start relative shrink-0" data-name="List Item">
                        <TitleText text="ARN/RRN" />
                        <div className="content-stretch flex flex-col gap-[4px] items-start relative shrink-0" data-name="Value list">
                          <div className="h-[20px] relative shrink-0 w-[398px]" data-name="Value">
                            <div className="absolute content-stretch flex gap-[4px] items-center left-0 top-0" data-name="value">
                              <p className="font-['Inter:Regular',sans-serif] leading-[20px] not-italic relative shrink-0 text-[#192839] text-[14px] text-nowrap">123456789012</p>
                              <div className="content-stretch flex items-center justify-center relative shrink-0" data-name="copy">
                                <div className="content-stretch flex items-center justify-center relative shrink-0" data-name="root">
                                  <div className="content-stretch flex items-center justify-center relative shrink-0" data-name="wrapper">
                                    <IconWrapper />
                            ...
                            <div className="content-stretch flex items-end justify-end relative shrink-0" data-name="Amount">
                              <div className="content-stretch flex items-baseline relative shrink-0" data-name="root">
                                <div className="content-stretch flex gap-[2px] items-baseline relative shrink-0" data-name="_AmountBase">
                                  ...
                                  <div className="content-stretch flex items-baseline relative shrink-0" data-name="value-container">
                                    <div className="content-stretch flex items-baseline relative shrink-0" data-name="main-value-container">
                                      <p className="font-['Inter:Regular',sans-serif] leading-[20px] not-italic relative shrink-0 text-[#192839] text-[14px] text-nowrap text-right">1,000</p>
                                    </div>
                                    <Text4 text=".00" />
                                  </div>
                                  <p className="absolute font-['Inter:Regular',sans-serif] leading-[14px] left-[21px] not-italic opacity-0 text-[#192839] text-[10px] text-nowrap text-right top-0 translate-x-[-100%]">INR</p>
                      ...
                      <Divider />
                      <div className="content-stretch flex gap-[12px] items-start relative shrink-0" data-name="List Item">
                        <TitleText1 text="Issued on" />
                        <div className="content-stretch flex flex-col gap-[4px] items-start relative shrink-0" data-name="Value list">
                          <div className="h-[20px] relative shrink-0 w-[398px]" data-name="Value">
                            <ValueText text="Fri Feb 9, 2023, 1:12pm" />
                          </div>
                        </div>
                      </div>
                      <Divider />
                      <div className="content-stretch flex gap-[12px] items-start relative shrink-0 w-full" data-name="List Item">
                        <TitleText1 text="Timeline" />
                        <div className="content-stretch flex items-center pl-0 pr-[20px] py-0 relative shrink-0" data-name="Refund timeline">
                          <div className="flex flex-row items-center self-stretch">
                            <div className="content-stretch flex flex-col h-full items-start mr-[-20px] relative shrink-0" data-name="line">
                              <div className="h-[78px] relative shrink-0 w-[20px]" data-name="Line element">
                                <div className="absolute h-[78px] left-0 top-0 w-[20px]" data-name="bg" />
                                <div className="absolute flex h-[66px] items-center justify-center left-[9.5px] top-[24px] w-0" style={{ "--transform-inner-width": "0", "--transform-inner-height": "0" } as React.CSSProperties}>
                                  <div className="flex-none rotate-[90deg]">
                                    <div className="h-0 relative w-[66px]" data-name="Divider - 50">
                                      <div className="absolute inset-[-1px_0_0_0]">
                                        <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 66 1">
                                          <g id="Divider - 50">
                                            <line id="Divider Line" stroke="var(--stroke-0, #6C849D)" strokeOpacity="0.18" x2="66" y1="0.5" y2="0.5" />
                                          </g>
                                        </svg>
                                      </div>
                                    </div>
                          ...
                          <div className="content-stretch flex flex-col gap-[38px] items-start mr-[-20px] relative shrink-0">
                            <div className="content-stretch flex gap-[12px] items-start relative shrink-0" data-name="TImeline molecule/default">
                              <div className="relative shrink-0 size-[20px]" data-name="Substate">
                                <div className="absolute inset-0" style={{ "--fill-0": "rgba(233, 105, 12, 1)" } as React.CSSProperties}>
                                  <Wrapper5>
                                    <rect fill="var(--fill-0, #E9690C)" fillOpacity="0.09" height="20" rx="10" width="20" />
                                    <circle cx="10" cy="10" fill="var(--fill-0, #E9690C)" id="Ellipse 63" r="5" />
                                  </Wrapper5>
                                </div>
                              </div>
                              <div className="content-stretch flex flex-col gap-[4px] items-start relative shrink-0 w-[262px]" data-name="Timeline atom">
                                <Text5 text="Refund processing" />
                                <div className="flex flex-col font-['Inter:Regular',sans-serif] justify-center leading-[18px] not-italic relative shrink-0 text-[#40566d] text-[12px] w-full">
                                  <p className="mb-0">Mon 15 Oct, 2023, 12:17am</p>
                                  <p>takes 3-5 working days to process</p>
                                </div>
                              </div>
                            </div>
                            <div className="content-stretch flex gap-[12px] items-start relative shrink-0" data-name="TImeline molecule/default">
                              <div className="relative shrink-0 size-[20px]" data-name="Substate">
                                <div className="absolute inset-0" style={{ "--fill-0": "rgba(108, 132, 157, 1)" } as React.CSSProperties}>
                                  <Wrapper5>
                                    <rect fill="var(--fill-0, #6C849D)" fillOpacity="0.09" height="20" rx="10" width="20" />
                                    <circle cx="10" cy="10" fill="var(--fill-0, #2F4256)" id="Ellipse 63" r="5" />
                                  </Wrapper5>
                                </div>
                              </div>
                              <div className="content-stretch flex flex-col gap-[12px] items-start relative shrink-0 w-[262px]" data-name="Timeline atom">
                                <div className="content-stretch flex flex-col gap-[4px] items-start relative shrink-0 w-full">
                                  <Text5 text="Refund processed" />
                                  <div className="flex flex-col font-['Inter:Regular',sans-serif] justify-center leading-[0] not-italic relative shrink-0 text-[#40566d] text-[12px] w-full">
                                    <p className="leading-[18px]">Expected by Thu Feb 16, 2023</p>
                                  </div>
                                </div>
                                <div className="flex flex-col font-['Inter:Medium',sans-serif] justify-center leading-[0] not-italic relative shrink-0 text-[#768ea7] text-[12px] w-full">
                                  <p className="leading-[18px]">[Amount will be credited to customer’s bank account within 5-7 working days after the refund has processed]</p>
                                </div>
                              </div>
                            </div>
                          </div>
                  ...
                  <div className="bg-[#f1f5fa] content-stretch flex flex-col items-start px-[16px] py-[12px] relative rounded-bl-[4px] rounded-br-[4px] shrink-0 w-[650px]" data-name="Footer">
                    <div aria-hidden="true" className="absolute border-[0px_1px_1px] border-[rgba(108,132,157,0.18)] border-solid inset-0 pointer-events-none rounded-bl-[4px] rounded-br-[4px]" />
                    <div className="content-stretch flex gap-[4px] items-center relative shrink-0 w-full">
                      <p className="font-['Inter:Regular',sans-serif] leading-[18px] not-italic relative shrink-0 text-[#40566d] text-[12px] text-nowrap">*Refund amount is deducted from your Razorpay current balance after getting processed</p>
                    </div>
                  </div>
                </div>
              </div>
          ...
          <div className="[grid-area:1_/_1] grid-cols-[max-content] grid-rows-[max-content] inline-grid ml-[16px] mt-[76px] place-items-start relative">
            <div className="[grid-area:1_/_1] content-stretch flex flex-col gap-[40px] items-start ml-0 mt-0 relative">
              ...
              <div className="content-stretch flex gap-[12px] items-start relative shrink-0" data-name="TImeline molecule/default">
                ...
                <div className="content-stretch flex flex-col gap-[4px] items-start relative shrink-0 w-[262px]" data-name="Timeline atom">
                  <Text5 text="Payment authorized" />
                  <div className="flex flex-col font-['Inter:Regular',sans-serif] justify-center leading-[0] not-italic relative shrink-0 text-[#40566d] text-[12px] w-full">
                    <p className="leading-[18px]">Sat Feb 10, 2023, 12:17am</p>
                  </div>
                </div>
              </div>
              <div className="content-stretch flex gap-[12px] items-start relative shrink-0" data-name="TImeline molecule/default">
                ...
                <div className="content-stretch flex flex-col gap-[4px] items-start relative shrink-0 w-[262px]" data-name="Timeline atom">
                  <Text5 text="Payment captured" />
                  <div className="flex flex-col font-['Inter:Regular',sans-serif] justify-center leading-[0] not-italic relative shrink-0 text-[#40566d] text-[12px] w-full">
                    <p className="leading-[18px]">Sun Feb 11, 2023, 1:17am</p>
                  </div>
                </div>
              </div>
              <div className="content-stretch flex gap-[12px] items-start relative shrink-0" data-name="TImeline molecule/default">
                <div className="bg-[rgba(233,105,12,0.09)] content-stretch flex items-center justify-center p-[4px] relative rounded-[100px] shrink-0 size-[20px]" data-name="State">
                  <Clock />
                </div>
                <div className="content-stretch flex flex-col gap-[8px] items-start relative shrink-0 w-[262px]" data-name="Timeline atom">
                  <div className="content-stretch flex flex-col gap-[4px] items-start leading-[0] not-italic relative shrink-0">
                    <Helper text="Refund" text1="(Processing)" />
                    <div className="flex flex-col font-['Inter:Regular',sans-serif] justify-center leading-[18px] relative shrink-0 text-[#40566d] text-[12px] w-[262px]">
                      <p className="mb-0">{`Amount: ₹5000 `}</p>
                      <p>Issued on: Fri Feb 9, 2023, 1:12pm</p>
                    </div>
                  </div>
                  <div className="content-stretch flex flex-col gap-[4px] items-start relative shrink-0">
                    <div className="content-stretch flex flex-col items-start relative shrink-0" data-name="Link">
                      <div className="content-stretch flex items-center justify-center relative shrink-0" data-name="root">
                        <div className="content-stretch flex gap-[4px] items-center justify-center relative shrink-0" data-name="wrapper">
                          <LabelText text="Show timeline" />
                          <div className="content-stretch flex items-center relative shrink-0" data-name="trailing-icon">
                            <Wrapper1>
                              <path d={svgPaths.p191436c0} fill="var(--fill-0, #2950DA)" id="Union" />
                            </Wrapper1>
                          </div>
                        </div>
                      </div>
              ...
              <div className="content-stretch flex gap-[12px] items-start relative shrink-0" data-name="TImeline molecule/default">
                ...
                <div className="content-stretch flex flex-col gap-[8px] items-start relative shrink-0 w-[262px]" data-name="Timeline atom">
                  <div className="content-stretch flex flex-col gap-[4px] items-start leading-[0] not-italic relative shrink-0">
                    <Helper text="Settlement" text1="(To be processed)" />
                    <div className="flex flex-col font-['Inter:Regular',sans-serif] justify-center leading-[18px] relative shrink-0 text-[#40566d] text-[12px] w-[262px]">
                      <p className="mb-0">Net amount: ₹4,800</p>
                      <p>To be deposited by: Thu Feb 14, 2023</p>
                    </div>
                  </div>
                  <div className="content-stretch flex flex-col gap-[4px] items-start relative shrink-0">
                    <div className="content-stretch flex flex-col items-start relative shrink-0" data-name="Link">
